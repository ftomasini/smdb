...
class AlarmisticaModel extends DbConection
{
    private $table;
    ...
    public static function verificaAlarme($usuario, $alarme)
    {
        self::openDb();
    ...
    public function insert( $usuario, $alarme )
    {
        $this->openDb();
        $dbUsuario = ($usuario != NULL)?"'".pg_escape_string($usuario)."'":'NULL';
    ...
    public function delete( $usuario, $alarme )
    {
        $this->openDb();
        $dbUsuario = ($usuario != NULL)?"'".pg_escape_string($usuario)."'":'NULL';
        $dbMetodo = ($metodo != NULL)?"'".pg_escape_string($metodo)."'":'NULL';
